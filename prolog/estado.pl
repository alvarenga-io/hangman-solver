:- module(state, [iniciar_partida/2, categoria/1, tamanho/1, candidato/1, tentadas/1, padrao/1, vidas/1]); %cria o modulo e exporta os predicados para que outro arquivos possam usá-los
